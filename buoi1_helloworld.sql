...
CREATE TABLE `helloworld` (
  ...
  `word` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `helloworld` VALUES (1,'Hello'),(2,'Xin chào'),(3,'Halo'),(4,'heyj');
...
-- Dump completed on 2019-08-19  0:38:17
